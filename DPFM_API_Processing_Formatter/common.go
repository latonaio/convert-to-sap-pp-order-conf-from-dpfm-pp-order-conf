...
import (
	"convert-to-sap-pp-order-conf-from-dpfm-pp-order-conf/DPFM_API_Caller/requests"
...
func (p *ProcessingFormatter) ConversionProcessingKey(
	sdc *dpfm_api_input_reader.SDC,
	labelConvertFrom,
	labelConvertTo string,
	codeConvertFrom any,
) *ConversionProcessingKey {
...
func (p *ProcessingFormatter) ConversionProcessingCommonQueryGets(
	dataKey []*ConversionProcessingKey,
) ([]*ConversionProcessingCommonQueryGets, error) {
...
func (p *ProcessingFormatter) CodeConversionFromInt(
	dataKey []*ConversionProcessingKey,
	res []*ConversionProcessingCommonQueryGets,
) ([]*ConversionProcessingCommonQueryGets, error) {
	var args []interface{}
